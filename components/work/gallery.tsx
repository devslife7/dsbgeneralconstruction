...
export default async function Gallery() {
  ...
  return (
    <div className="lg:mt-10 mx-auto lg:container lg:px-8">
      <div className="my-container">
        <h1 className="text-center text-4xl font-bold opacity-70 mb-10 lg:mb-1 hidden lg:block">Our Work</h1>
        <p className="hidden lg:block text-center w-full m-auto opacity-60 mb-10">
