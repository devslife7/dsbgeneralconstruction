  ...
  return (
    <DialogContent className={cn("", { "h-full": work.Review.length > 0 })}>
      <DialogHeader>
        <DialogTitle>
          <div className="flex justify-between">
            <div>
              ...
              <div className="text-lg font-normal opacity-60">
                {work.description}
              </div>
            </div>
            <div className="mt-5 flex">
              <div className="mr-1 mt-[0.1rem] text-xl font-normal opacity-70">
        ...
        <div
          className="mb-10 cursor-pointer text-center opacity-50"
