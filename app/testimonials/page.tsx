...
// The main component that holds multiple testimonials
const Testimonials = () => {
  ...
  return (
    <div className="bg-gray-50 py-12">
      <div className="mb-12 text-center">
        <h2 className="text-4xl font-bold text-gray-800">Our happy clients say about us</h2>
        <p className="mt-2 text-gray-500">2,157 people have said how good Rareblocks</p>
      </div>
